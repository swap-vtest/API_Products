...
public class PostM {
	...
	public void APIResponse(String aisle, String isbn) throws IOException {
		...
		/**/ String response = request.body(payload.Addbook(aisle, isbn)).when()/**/
	...
	public Object[][] getData() {
		return new Object[][] { { "RJ20 20140004739", "RC1 Lite is Verified by author" },
				{ "2RJ20 20140004739", "RC2 Lite is Verified by author" } };
